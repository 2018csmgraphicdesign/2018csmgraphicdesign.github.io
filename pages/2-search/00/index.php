...
<body>
      ...
      <!-- important -->
				...
				<section class="search--results hide">
					<?php
          echo "<section class='list list-img'>\n";
          $f = fopen("csv/data-04.csv", "r");
                  ...
                  //IMPORTANT
                    ...
                    echo "<div class='img' style='background-image: url(" . htmlspecialchars($cell) . ");' ";
									}
                  $row = $line[1];
                  $cells = explode(";",$row);
                  foreach ($cells as $cell) {
                    echo ">" . htmlspecialchars($cell) . "</div>";
                  }
          ...
          while (($line = fgetcsv($f)) !== false) {
                  ...
                  //IMPORTANT
          				...
          				foreach ($cells as $cell) {
          						echo "<p class='img imgshow'>" . htmlspecialchars($cell) . "</p>";
          				}
